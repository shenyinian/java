...
<body>
    ...
    <div class="user_cont">
         ...
         <div class="user_cont_left">
               ...
               <dl>
                   <dt>社区中心</dt>
                   <dd  class="active"><a href="${ctx}/user_12.jsp">我的评论</a></dd>
           ...
           <div class="user_coment">
                 <div class="my_comments">
                     <ul>
                         <li>
                             <div class="my_co_1">
                                  <div class="my_co_11"><a href="" target="_blank"><img src="images/my_pl_img.jpg" width="47" height="60" /></a></div>
                                  <div class="my_co_12">英语阅读理解与完形填空150篇：七年级阅读理解篇，快速阅读</div>
                                  <div class="my_co_13">2014-12-10</div>
                                  <div class="my_co_14"><a href="">删除</a></div>
                             </div>
                             <div class="my_co_2"><span class="red">我的评论：</span>书籍的内容很好，很适合学生阅读，提高了学生的阅读能力，特别值得推荐</div>
