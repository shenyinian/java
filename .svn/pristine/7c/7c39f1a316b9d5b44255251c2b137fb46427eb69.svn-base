...
<body class="body_login">
	<div class="login_t">
		...
		<div class="login_title">欢迎管理员</div>
		<div class="login_txt">
	...
	<div class="login_c">
		<div class="login_c_left">
			<img src="images/admin.jpg" width="369" height="314" />
		</div>
		<div class="login_c_right">
			<form action="${ctx}/admin?method=login" method="post">
			...
			<div class="login_zc">
				<a href="" target="_blank" class="login_zc1">忘记登陆密码</a> <a href="${ctx}/regist.jsp"
