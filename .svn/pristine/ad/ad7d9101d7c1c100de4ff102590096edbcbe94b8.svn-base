    ...
    <div class="user_cont">
         ...
         <div class="user_cont_left">
               <dl>
                   ...
                   <dd class="active"><a href="${ctx}/vip?method=listBought">已经购买的商品</a></dd>
               </dl>
               <dl>
                   <dt>自助服务</dt>
...
$(document).ready(function(){
		...
		$(this).toggleClass("jia"); return false;
         ...
         <div class="user_cont_right">
                    <form id="form1" action="${ctx}/customer?method=user_5" method="post">
                 ...
                 <table width="713" border="0" cellspacing="0" cellpadding="0"  class="my_dd">
                       <tr>
                        ...
                        <tr>
                            ...
                            <td>${book.bcount}</td>
                            <td>${book.bcount * book.discountprice}</td>
                            <td>
