    ...
    <div class="user_cont">
         ...
         <div class="user_cont_left">
               <dl>
                   ...
                   <dd class="active"><a href="${ctx}/user_2.jsp">我的收藏</a></dd>
...
$(document).ready(function(){
       ...
       <!-- <form id="form1" action="${ctx}/vip?method=listBought" method="post"> --> 
           <div class="user_lmt">
                    <div class="user_lmt1">我的收藏</div>
                    <div class="user_lmt2">
                         <div class="user_lmt22"><a href=""><img src="images/user_plgm.jpg" width="70" height="22" /></a></div>
                 ...
                 <table width="713" border="0" cellspacing="0" cellpadding="0"  class="my_dd">
                       <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="3"><a href="" target="_blank">英语阅读理解与完形填空150篇：七年级</a></td>
                            <td>20</td>
                            <td>
                                 <div class="user_ck"><a href="" target="_blank">查看</a></div>
                                 <div class="user_pj"><a href="" target="_blank">付款</a></div>
